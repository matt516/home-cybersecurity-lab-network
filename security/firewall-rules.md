...
- Allow TCP/UDP traffic from ADMIN subnets through port 22 to SERVERS subnets
- Allow TCP/UDP traffic from ADMIN subnets through ports 80, 443
- Block all traffic from ADMIN subnets (Implicit Deny)
...
- Block all traffic from SERVERS subnets (Implicit Deny)
...
- Allow TCP traffic from ATTACK subnets through port 1515 to 10.0.20.70
- Allow TCP/UPD traffic from ATTACK subnets through port 1514 to 10.0.20.70
- Allow TCP/UDP traffic from ATTACK subnets through port 22 to 10.0.20.50
...
- Block all traffic from ATTACK subnets (Implicit Deny)
